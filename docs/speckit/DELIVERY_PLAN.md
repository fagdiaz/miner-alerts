...
| Spec 022 acquisition | Isolated module/tests started 2026-08-14; monitor wiring after Spec 021 D+1 | Activation only after Spec 021 D+3, then shadow/review window | Shadow comparison, bounded requests/latency, unchanged state/action/offset, D+1/D+3. |
...
| Spec 029 release stabilization | 2026-11-27 to 2026-12-06 | 2026-12-07 to 2026-12-20 | Terminal dependency manifest, R001-R025, restore/rollback proof and one payload-stable 168-hour review with hour-72 checkpoint; no open P0/P1. |
